...
//dimensions
sys_gui("set var_scope_wdt [concat scope_wdt_$vid]\n");
sys_gui("global $var_scope_wdt\n");
sys_gui("set var_scope_hgt [concat scope_hgt_$vid]\n");
sys_gui("global $var_scope_hgt\n");
sys_gui("set var_scope_wdt_min [concat scope_wdt_min_$vid]\n");
sys_gui("global $var_scope_wdt_min\n");
sys_gui("set var_scope_hgt_min [concat scope_hgt_min_$vid]\n");
sys_gui("global $var_scope_hgt_min\n");
//buffer
sys_gui("set var_scope_cal [concat scope_cal_$vid]\n");
sys_gui("global $var_scope_cal\n");
sys_gui("set var_scope_bfs [concat scope_bfs_$vid]\n");
sys_gui("global $var_scope_bfs\n");
...
sys_gui("set var_scope_bfs_min [concat scope_bfs_min_$vid]\n");
sys_gui("global $var_scope_bfs_min\n");
sys_gui("set var_scope_bfs_max [concat scope_bfs_max_$vid]\n");
sys_gui("global $var_scope_bfs_max\n");
//delay
...
//dimensions
sys_gui("if { [eval concat $$var_scope_wdt] < [eval concat $$var_scope_wdt_min] } {\n");
sys_gui("set $var_scope_wdt [eval concat $$var_scope_wdt_min] \n");
sys_gui("$mytoplevel.dim.fr.w_ent configure -textvariable $var_scope_wdt\n");
sys_gui("}\n");
sys_gui("if { [eval concat $$var_scope_hgt] < [eval concat $$var_scope_hgt_min] } {\n");
sys_gui("set $var_scope_hgt [eval concat $$var_scope_hgt_min] \n");
sys_gui("$mytoplevel.dim.fr.h_ent configure -textvariable $var_scope_hgt\n");
sys_gui("}\n");
//buffer
...
sys_gui("$mytoplevel.buf.fr.cal_ent configure -textvariable $var_scope_cal\n");
sys_gui("}\n");
sys_gui("if { [eval concat $$var_scope_bfs] < [eval concat $$var_scope_bfs_min] } {\n");
sys_gui("set $var_scope_bfs [eval concat $$var_scope_bfs_min] \n");
sys_gui("$mytoplevel.buf.fr.bfs_ent configure -textvariable $var_scope_bfs\n");
sys_gui("}\n");
sys_gui("if { [eval concat $$var_scope_bfs] > [eval concat $$var_scope_bfs_max] } {\n");
sys_gui("set $var_scope_bfs [eval concat $$var_scope_bfs_max] \n");
sys_gui("$mytoplevel.buf.fr.bfs_ent configure -textvariable $var_scope_bfs\n");
sys_gui("}\n");
//delay
...
sys_gui("set vid [string trimleft $mytoplevel .]\n");
sys_gui("set var_scope_min_rng [concat scope_min_rng_$vid]\n");
sys_gui("global $var_scope_min_rng\n");
sys_gui("set var_scope_max_rng [concat scope_max_rng_$vid]\n");
sys_gui("global $var_scope_max_rng\n");
sys_gui("if { [eval concat $$var_scope_min_rng] > [eval concat $$var_scope_max_rng] } {\n");
sys_gui("set temp [eval concat $$var_scope_min_rng]\n");
sys_gui("set $var_scope_min_rng [eval concat $$var_scope_max_rng]\n");
sys_gui("set $var_scope_max_rng [eval concat $temp]\n");
sys_gui("$mytoplevel.rng.fr.min_ent configure -textvariable $var_scope_min_rng\n");
sys_gui("$mytoplevel.rng.fr.max_ent configure -textvariable $var_scope_max_rng\n");
sys_gui("}\n");
sys_gui("}\n");
...
sys_gui("set var_scope_drs [concat scope_drs_$vid]\n");
sys_gui("set var_scope_wdt_init [concat scope_wdt_init_$vid]\n");
sys_gui("global $var_scope_wdt_init\n");
sys_gui("set var_scope_hgt_init [concat scope_hgt_init_$vid]\n");
sys_gui("global $var_scope_hgt_init\n");
sys_gui("set var_scope_cal_init [concat scope_cal_init_$vid]\n");
sys_gui("global $var_scope_cal_init\n");
sys_gui("set var_scope_bfs_init [concat scope_bfs_init_$vid]\n");
sys_gui("global $var_scope_bfs_init\n");
sys_gui("set var_scope_min_rng_init [concat scope_min_rng_init_$vid]\n");
sys_gui("global $var_scope_min_rng_init\n");
sys_gui("set var_scope_max_rng_init [concat scope_max_rng_init_$vid]\n");
sys_gui("global $var_scope_max_rng_init\n");
...
sys_gui("if {[eval concat $$var_scope_wdt] eq \"\"} {set $var_scope_wdt [eval concat $$var_scope_wdt_init]}\n");
sys_gui("if {[eval concat $$var_scope_hgt] eq \"\"} {set $var_scope_hgt [eval concat $$var_scope_hgt_init]}\n");
sys_gui("if {[eval concat $$var_scope_cal] eq \"\"} {set $var_scope_cal [eval concat $$var_scope_cal_init]}\n");
sys_gui("if {[eval concat $$var_scope_bfs] eq \"\"} {set $var_scope_bfs [eval concat $$var_scope_bfs_init]}\n");
sys_gui("if {[eval concat $$var_scope_min_rng] eq \"\"} {set $var_scope_min_rng [eval concat $$var_scope_min_rng_init]}\n");
sys_gui("if {[eval concat $$var_scope_max_rng] eq \"\"} {set $var_scope_max_rng [eval concat $$var_scope_max_rng_init]}\n");
...
sys_gui("set var_scope_tmd0 [concat scope_tmd0_$vid]\n");
sys_gui("global $var_scope_tmd0\n");
sys_gui("set var_scope_tmd1 [concat scope_tmd1_$vid]\n");
sys_gui("global $var_scope_tmd1\n");
sys_gui("set var_scope_tmd2 [concat scope_tmd2_$vid]\n");
sys_gui("global $var_scope_tmd2\n");
sys_gui("if {$tmd == 0} {\n");
sys_gui("set $var_scope_tmd 0\n");
sys_gui("$mytoplevel.trg.tmd.trb configure -text [eval concat $$var_scope_tmd0]\n");
sys_gui("} elseif {$tmd == 1} {\n");
sys_gui("set $var_scope_tmd 1\n");
sys_gui("$mytoplevel.trg.tmd.trb configure -text [eval concat $$var_scope_tmd1]\n");
sys_gui("} else {\n");
sys_gui("set $var_scope_tmd 2\n");
sys_gui("$mytoplevel.trg.tmd.trb configure -text [eval concat $$var_scope_tmd2]\n");
sys_gui("}\n");
// for OSX live updates
sys_gui("if {$::windowingsystem eq \"aqua\"} {\n");
sys_gui("::dialog_scope::apply_and_rebind_return $mytoplevel\n");
...
sys_gui("[eval concat $$var_scope_wdt] \\\n");
sys_gui("[eval concat $$var_scope_hgt] \\\n");
sys_gui("[eval concat $$var_scope_cal] \\\n");
sys_gui("[eval concat $$var_scope_bfs] \\\n");
sys_gui("[eval concat $$var_scope_min_rng] \\\n");
sys_gui("[eval concat $$var_scope_max_rng] \\\n");
sys_gui("[eval concat $$var_scope_del] \\\n");
sys_gui("[eval concat $$var_scope_drs] \\\n");
...
sys_gui("set var_scope_tlv_init [concat scope_tlv_init_$vid]\n");
sys_gui("global $var_scope_tlv_init\n");
sys_gui("set $var_scope_wdt $wdt\n");
sys_gui("set $var_scope_hgt $hgt\n");
sys_gui("set $var_scope_cal $cal\n");
sys_gui("set $var_scope_bfs $bfs\n");
sys_gui("set $var_scope_min_rng $min_rng\n");
sys_gui("set $var_scope_max_rng $max_rng\n");
sys_gui("set $var_scope_del $del\n");
sys_gui("set $var_scope_drs $drs\n");
...
sys_gui("set $var_scope_wdt_init $wdt\n");
sys_gui("set $var_scope_hgt_init $hgt\n");
sys_gui("set $var_scope_cal_init $cal\n");
sys_gui("set $var_scope_bfs_init $bfs\n");
sys_gui("set $var_scope_min_rng_init $min_rng\n");
sys_gui("set $var_scope_max_rng_init $max_rng\n");
sys_gui("set $var_scope_del_init $del\n");
sys_gui("set $var_scope_tlv_init $tlv \n");
sys_gui("set $var_scope_wdt_min $wdt_min\n");
sys_gui("set $var_scope_hgt_min $hgt_min\n");
sys_gui("set $var_scope_cal_min $cal_min\n");
sys_gui("set $var_scope_cal_max $cal_max\n");
sys_gui("set $var_scope_bfs_min $bfs_min\n");
sys_gui("set $var_scope_bfs_max $bfs_max\n");
...
sys_gui("entry $mytoplevel.dim.fr.w_ent -textvariable $var_scope_wdt -width 4\n");
sys_gui("label $mytoplevel.dim.fr.dummy1 -text \"\" -width 1\n");
sys_gui("label $mytoplevel.dim.fr.h_lab -text [_ $hgt_label]\n");
sys_gui("entry $mytoplevel.dim.fr.h_ent -textvariable $var_scope_hgt -width 4\n");
...
sys_gui("entry $mytoplevel.buf.fr.bfs_ent -textvariable $var_scope_bfs -width 4\n");
...
sys_gui("entry $mytoplevel.rng.fr.min_ent -textvariable $var_scope_min_rng -width 8\n");
sys_gui("label $mytoplevel.rng.fr.dummy1 -text \"\" -width 1\n");
sys_gui("label $mytoplevel.rng.fr.max_lab -text [_ $max_rng_label]\n");
sys_gui("entry $mytoplevel.rng.fr.max_ent -textvariable $var_scope_max_rng -width 8\n");
...
sys_gui("if {[eval concat $$var_scope_tmd] == 1} \\\n");
sys_gui("{ set current_tmd \"Up\" }\n");
sys_gui("if {[eval concat $$var_scope_tmd] == 2} \\\n");
...
sys_gui("checkbutton $mytoplevel.misc.fr.drs_chk -variable $var_scope_drs \\\n");
...
sys_gui("bind $mytoplevel.buf.fr.bfs_ent <KeyPress-Return> \"::dialog_scope::apply_and_rebind_return $mytoplevel\"\n");
sys_gui("bind $mytoplevel.rng.fr.min_ent <KeyPress-Return> \"::dialog_scope::apply_and_rebind_return $mytoplevel\"\n");
sys_gui("bind $mytoplevel.rng.fr.max_ent <KeyPress-Return> \"::dialog_scope::apply_and_rebind_return $mytoplevel\"\n");
...
sys_gui("$mytoplevel.buf.fr.bfs_ent config -validate focusin -vcmd \"::dialog_scope::unbind_return $mytoplevel\"\n");
sys_gui("$mytoplevel.rng.fr.min_ent config -validate focusin -vcmd \"::dialog_scope::unbind_return $mytoplevel\"\n");
sys_gui("$mytoplevel.rng.fr.max_ent config -validate focusin -vcmd \"::dialog_scope::unbind_return $mytoplevel\"\n");
