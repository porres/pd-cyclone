...
Location of this repository is https://github.com/porres/pd-cyclone. The original cyclone repository is <https://git.puredata.info/cgit/svn2git/libraries/miXed.git/>, which, amongst other things, includes the cyclone library version 0.1-Alpha56, present in the last release of Pd Extended [version 0.43.4] - available in the deken plug in as "cyclone-v0-0extended". A fork from this repository is found at <https://github.com/electrickery/pd-miXedSon>, and includes a newer version "0.2beta1" - also available for download via the deken plug in. The work from <https://github.com/electrickery/pd-miXedSon> is now forked this new repository. Another version (probably still "0.2beta-x") could emerge anytime from this repository with bug fixes, new objects and new functionalities.
